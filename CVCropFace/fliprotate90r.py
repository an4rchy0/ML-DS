...
output_folder = r'D:\(D) Document\Project\Python\ML\CVCropFace\path\to\outputFlip2'
...
print(f"Semua gambar dari folder '{input_folder}' telah berhasil diputar 90 derajat dan disimpan di folder '{output_folder}' dengan format nama yang baru.")
